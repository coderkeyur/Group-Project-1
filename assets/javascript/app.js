$(document).ready(function () {
    ...
    function displayWeather() {
        ...
        $.ajax({
            ...
            var pTwo = $("<p>").html("<strong>Temperature: </strong>" + mainTemp);
            var pThree = $("<p>").html("<strong>Min Temperature: </strong> " + minTemp);
            var pFour = $("<p>").html("<strong>Max Temperature: </strong>" + maxTemp);
            var pSeven = $("<p>").html("<strong>Humidity: </strong>" + humidity);
